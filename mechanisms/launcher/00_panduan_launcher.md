...
Dokumen ini adalah panduan umum untuk sistem launcher/shooter di FTC — mekanisme yang melontarkan game piece ke target dari jarak jauh, alih-alih meletakkannya langsung. Setiap file di folder ini membahas satu jenis launcher: cara kerja, kelebihan, kekurangan, dan kapan sebaiknya dipakai.

## Daftar Jenis Launcher

| File | Jenis Launcher | Cocok Untuk |
|---|---|---|
| [01_flywheel_tunggal.md](01_flywheel_tunggal.md) | Flywheel Tunggal | Sederhana, jarak tembak sedang, budget terbatas |
| [02_flywheel_ganda.md](02_flywheel_ganda.md) | Flywheel Ganda (Double Flywheel) | Kecepatan lontar tinggi & konsisten, kontrol spin |
| [03_indexer_flywheel.md](03_indexer_flywheel.md) | Indexer + Flywheel (Continuous Feed) | Tembak berulang cepat (cycle time tinggi) |
| [04_catapult.md](04_catapult.md) | Catapult / Trebuchet | Sederhana secara elektrik, sekali lontar per siklus |
